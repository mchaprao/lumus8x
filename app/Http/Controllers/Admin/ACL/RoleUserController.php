...
class RoleUserController extends Controller
{
    ...
    public function roles($idUser)
    {
        ...
        return view('admin.users.roles.roles', compact('user', 'roles'));
    }
    ...
    public function users($idRole)
    {
        ...
        return view('admin.roles.users.users', compact('role', 'users'));
    }
    ...
    public function rolesAvailable(Request $request, $idUser)
    {
        ...
        return view('admin.users.roles.available', compact('user', 'roles', 'filters'));
    }
