                ...
                <form method="post" action="{{ route('equipments.update', $equipment->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="serial" id="name" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="description" id="description" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
                                   value="{{ old('name', $equipment->description) }}" />
                            @error('description')
                            <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <select name="status" id="status" class="form-select rounded-md shadow-sm mt-1 block w-full">
                                <option value="F" @if(isset($equipment) && $equipment->status == 'F') selected @endif >Funcionando</option>
                                <option value="M" @if(isset($equipment) && $equipment->status == 'M') selected @endif >Manutenção</option>
                                <option value="Q" @if(isset($equipment) && $equipment->status == 'Q') selected @endif >Quebrado</option>
                            </select>
                        </div>
