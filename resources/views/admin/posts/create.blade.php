            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" action="{{ route('posts.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <label for="published_at" class="block font-medium text-sm text-gray-700">* Data de Publicação</label>
                            <input type="date" name="published_at" id="published_at" type="text" class="form-input rounded-md shadow-sm mt-1 block w-full"
