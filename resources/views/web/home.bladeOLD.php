...
<header class="row header">
    ...
    <div class="content">
        ...
        <div class="header-collapse">
            <nav class="header-nav">
                ...
                <ul>                    
                    ...
                    <li><a href="#servicos" title="Serviços" class="">Serviços</a></li>
            ...
            <div class="header-acesso">
                <a href="{{ route('login') }}" target="_blank" class="btn btn-outline-success">Acesso Cliente</a>        
            </div>          
        ...
        {{-- <div>
            <button class="relative float-right m-4 px-6 py-2 text-sm font-medium leading-6 text-center text-white uppercase transition bg-green-500 border-8 border-black-500 rounded ripple hover:bg-green-100 hover:text-black focus:outline-none waves-effect">
                <a href="{{ route('login') }}" target="_blank">Acesso Cliente</a>
            </button>
        </div> --}}
</header>
{{-- end HEADER --}}
        ...
        <div id="mainSlider" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item">
                    <img src="{{ url('storage').'/'.$carousel->image }}" class="d-block w-100" alt="{{ $carousel->title }}">
...
<section class="section bg-gray-50" id="servicos">
    <header class="section-header">
        ...
        <button class="btn btn-front icon-info"> Teste</button>
...
{{-- Serviços 2 --}}
<section class="section bg-gray-50" id="servicos2">
    <header class="section-header">
        <div class="content">
            <h1><span>Serviços 2</span></h1>
            <p class="tagline">
                Nossos serviços são entregues por uma equipe com anos de experiência no mercado e apaixonados pelo desenvolvimento sustentável.
            </p>
        </div>
...
<section class="section" id="contato">
    <header class="section-header">
        <div class="content">
            ...
            <p>lumus@lumusambiental.com.br</p>
            <p>81 9 9900 1276</p>
        </div>
    </header>
